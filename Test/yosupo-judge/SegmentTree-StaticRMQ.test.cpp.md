...
data:
  ...
  bundledCode: "#line 1 \"Test/yosupo-judge/SegmentTree-StaticRMQ.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/staticrmq\"\n\n#include <bits/stdc++.h>\n\
    ...
    \ - 1] << \", \" << lazy[i + leaf_num - 1] << \"), \";\n\t\tcout << endl;\n\t\
    }\n};\n#line 6 \"Test/yosupo-judge/SegmentTree-StaticRMQ.test.cpp\"\ntypedef long\
  ...
  requiredBy: []
  timestamp: '2021-01-02 01:02:19+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: Test/yosupo-judge/SegmentTree-StaticRMQ.test.cpp
layout: document
redirect_from:
- /verify/Test/yosupo-judge/SegmentTree-StaticRMQ.test.cpp
- /verify/Test/yosupo-judge/SegmentTree-StaticRMQ.test.cpp.html

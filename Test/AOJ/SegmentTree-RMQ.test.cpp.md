...
data:
  ...
  bundledCode: "#line 1 \"Test/AOJ/SegmentTree-RMQ.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/problems/DSL_2_A\"\n\n#include <bits/stdc++.h>\n\
    ...
    \ \" << lazy[i + leaf_num - 1] << \"), \";\n\t\tcout << endl;\n\t}\n};\n#line\
    \ 6 \"Test/AOJ/SegmentTree-RMQ.test.cpp\"\ntypedef long long ll;\n\nint main()\
    \ {\n\tll n, q;\n\tcin >> n >> q;\n\tSegmentTree<ll> segtree(n+10, true, INT_MAX,\
  ...
  verifiedWith: []
documentation_of: Test/AOJ/SegmentTree-RMQ.test.cpp
layout: document
redirect_from:
- /verify/Test/AOJ/SegmentTree-RMQ.test.cpp
- /verify/Test/AOJ/SegmentTree-RMQ.test.cpp.html
